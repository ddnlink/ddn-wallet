...
class DelegateModal extends PureComponent {
  ...
  render() {
    ...
    return (
      <div>
        <h2 style={{textAlign:"center"}}><Icon type="user" theme="outlined" style={{marginRight:"20px"}} /> {formatMessage({ id: 'app.vote.detail' })}</h2>
        <div>
          ...
          <Row style={{padding:"10px", backgroundColor:"#f5f5f5"}}>
            ...
            <Col span={18}>
              <div style={rightStyle}>{`${curDelegate.publicKey.slice(1,20)  }...${  curDelegate.publicKey.slice(-20)}`}</div>
            </Col>
          </Row>
          <Row style={{padding:"10px"}}>
            <Col span={6}>
