    ...
    return (
      <div>
        <Button type="primary" onClick={this.handleOpenModal}>
          ...
          />
          {deVote
            ? formatMessage({ id: 'app.vote.devote' })
            : formatMessage({ id: 'app.vote.vote' })}
        </Button>
        <Modal
          title={
            deVote
              ? formatMessage({ id: 'app.vote.devote-for-delegate' })
              : formatMessage({ id: 'app.vote.vote-for-delegate' })
          }
          centered
          visible={visible}
          ...
          okText={
            deVote
              ? formatMessage({ id: 'app.vote.sure-to-devote' })
              : formatMessage({ id: 'app.vote.sure-to-vote' })
          }
          destroyOnClose
        >
          <div style={{ textAlign: 'center', margin: '20px' }}>
            {formatMessage({ id: 'app.vote.info' })} 0.1 DDN
          </div>
