...
import { Drawer, Typography, Spin, Card, Divider } from 'antd';
import { CodeOutlined, BookOutlined } from '@ant-design/icons';
import { useIntl } from '@umijs/max';
import styles from './ContractSpecDrawer.less';
 ...
 * 智能合约规范文档抽屉组件
 */
const ContractSpecDrawer: React.FC<ContractSpecDrawerProps> = ({ visible, onClose }) => {
  const intl = useIntl();
    ...
    <Drawer
      title={
        <div className={styles.drawerTitle}>
          <BookOutlined className={styles.drawerTitleIcon} />
          <span>DDN智能合约规范</span>
        </div>
      }
      width={800}
...
export default ContractSpecDrawer;
